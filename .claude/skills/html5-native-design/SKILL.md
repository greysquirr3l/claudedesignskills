...
- `assets/groundtruth/html5_apis_lab.html` — **ground-truth
  reference**: copy of `2026_html5_apis.html` from
  `greysquirr3l/pattern_lab`. Thirteen finished Web-platform-API
  examples with the dark navy / neon palette.
- `assets/groundtruth/periodic_table.html` — **ground-truth
  reference**: copy of the `periodic_table.html` from
  `greysquirr3l/pattern_lab`. A complete interactive periodic
  table built with native HTML (popovers, container queries, no
  framework).
